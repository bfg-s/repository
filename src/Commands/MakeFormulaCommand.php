...
class MakeFormulaCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $description = 'Create a new formula for Repository class';
    ...
    {
        if (! is_dir(app_path('Formulas'))) {
            mkdir(app_path('Formulas'), 0777, 1);
        }
...
TEXT;
    ...
    {
        return $this->resolveStubPath('/stubs/formula.stub');
    }
